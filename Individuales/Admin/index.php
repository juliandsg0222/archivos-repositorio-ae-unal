			...
			<div id="panel" class="panel panel-default" style="width: 100%; text-align:center; height: 100%;">
				...
				<div class="card" style="margin: 40px 4% 0 4%; transform: translateX(0);">
					<div class="card-title" style="background-color: #94b43b; height:60px; color: white; font-size:3.2em; padding:20px; margin-bottom: 0">
						<li id="principal">Página Principal</li>
						<li>|</li>
						<li id="salir">Cerrar Sesión</li>
					</div>
					...
					<div class="card-body" style="margin-bottom:0;">
						<div class="version2">
							...
							<!--Menú barra lateral-->
							<div class="BarraLateral" style="width: 21%;">

								<!--Icono y texto Archivo-->
								<li><span class="lnr lnr-users"> Administrar Usuarios</span></li>

								<!--Icono y texto Ejecutar-->
								<li><span class="lnr lnr-calendar-full"> Períodos Académicos</span></li>

								<!--Icono y texto Pausar-->
								<li><span class="lnr lnr-graduation-hat"> Programas Académicos</span></li>

								<!--Icono y texto Paso a Paso-->
								<li><span class="lnr lnr-bookmark"> Temas</span></li>

								<!--Icono y texto Mostrar Memoria-->
								<li><span class="lnr lnr-rocket"> Indicadores</span></li>

								<!--Icono y texto Descripción General-->
								<li><span class="lnr lnr-database"> Fuentes de Información</span></li>
							</div>
							<!--Fin barra lateral-->
							...
							<button type="button" class="btn btn-success btn-lg boton">Añadir Usuario</button>
							<button type="button" class="btn btn-primary btn-lg boton">Editar Usuario</button>
							<button type="button" class="btn btn-danger btn-lg boton">Eliminar Usuario</button>
