...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/fia_pregrados.css" media="all">
						...
						<div class="version2">
							...
							<div class="container" style="width: 100%;">
								<div class="row" style="width: 100%; margin-bottom: 48px">
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/A.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Arquitectura</h2>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/IC.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/IE.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
								...
								<div class="row" style="width: 100%; margin-bottom: 48px">
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/IET.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
