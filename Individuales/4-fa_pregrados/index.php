						...
						<div class="version2">
							...
							<div class="container" style="width: 100%;">
								<div class="row" style="width: 100%; margin-bottom: 48px">
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/AED.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Administración de Empresas (D)</h2>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/AEN.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Administración de Empresas (N)</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/ASI.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Administración de Sistemas Informáticos</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
								...
								<div class="row" style="width: 100%; margin-bottom: 48px">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/GCC.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Gestión Cultural y Comunicativa</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
