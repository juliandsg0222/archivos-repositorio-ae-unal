...
<head>
	...
	<!-- Inicio head plantilla pregrado_posgrado -->
	<link rel="stylesheet" type="text/css" href="css/fa_pregrados.css" media="all">
	<!-- Fin head plantilla pregrado_posgrado -->
</head>
<!-- Fin head -->
...
<body>
	...
	<!-- Inicio body plantilla pregrado_posgrado -->
		...
		<div class="row container_PRI" style="margin:0 0 0 0 !important; padding:0 0 0 0 !important">
			<div id="panel" class="panel panel-default" style="width: 100%; text-align:center; height: 100%;">
				...
				<div class="card" style="margin: 40px 4% 0 4%; transform: translateX(0);">
					<div class="card-title" style="background-color: #94b43b; height:60px; color: white; font-size:3.2em; padding:20px; margin-bottom: 0"></div>
						...
						<div class="version2">
							...
							<div class="container" style="width: 100%;">
								<div class="row" style="width: 100%; margin-bottom: 48px">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/EAG.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Especialización en Alta Gerencia</h2>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/EAS.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Especialización en Auditoría de Sistemas</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/EB.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Especialización en Bionegocios</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
								...
								<div class="row" style="width: 100%; margin-bottom: 48px">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/EFC.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Especialización en Finanzas Corporativas</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2_1" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/EGEP.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Especialización en Gerencia Estratégica de Proyectos</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2_2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/EGCCEPPC.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Especialización en Gestión Cultural y Comunicativa con Énfasis en Planeación y Políticas Culturales</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
								...
								<div class="row" style="width: 100%; margin-bottom: 48px">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/EGRD.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Especialización en Gestión de Redes de Datos</h2>
												<a class="info2" href="./index.php"></a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important"></div>
									</div>
	...
	<!-- Fin body plantilla pregrado_posgrado -->
