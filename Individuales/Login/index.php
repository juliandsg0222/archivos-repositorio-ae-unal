...
<head>
	...
	<script type="text/javascript" async="" src="http://www.google.com/cse/cse.js?cx=008572255874373046644:chip1p1uf-4"></script>
...
<body>
	...
	<div id="services" style="left: auto; top: auto; height: 927px; right: -262px;">
		<div class="indicator hidden-xs"></div>
		<ul class="dropdown-menu" style="height: 929px;">
			<li>
				<a href="http://correo.unal.edu.co" target="_blank"><img src="images/icnServEmail.png" alt="Correo Electrónico" width="32" height="32">Correo Electrónico</a>
			</li>
			<li>
				<a href="https://dninfoa.unal.edu.co" target="_blank"><img src="images/icnServSia.png" alt="Dirección Nacional de Información Académica" width="32" height="32">DNINFOA - SIA</a>
			</li>
			<li>
				<a href="http://bibliotecas.unal.edu.co" target="_blank"><img src="images/icnServLibrary.png" alt="Biblioteca" width="32" height="32">Bibliotecas</a>
			</li>
			<li>
				<a href="http://personal.unal.edu.co" target="_blank"><img src="images/icnServCall.png" alt="Convocatorias" width="32" height="32">Convocatorias</a>
			</li>
			<li>
				<a href="http://identidad.unal.edu.co"><img src="images/icnServIdentidad.png" alt="Identidad U.N." width="32" height="32">Identidad U.N.</a>
			</li>
		</ul>
	</div>
									...
									<tr>
										<td class="gsc-input">
											<div class="gsc-input-box" id="gsc-iw-id1">
												<table style="width: 100%; padding: 0px;" id="gs_id50" class="gstl_50 gsc-input" cellspacing="0" cellpadding="0">
													<tbody>
														<tr>
															<td id="gs_tti50" class="gsib_a"><input autocomplete="off" type="text" size="10" class="gsc-input" name="search" title="buscar" style="width: 100%; padding: 0px; border: medium none; margin: 0px; height: auto; background: rgb(255, 255, 255) url(&quot;https://www.google.com/cse/static/images/1x/es/branding.png&quot;) no-repeat scroll left center; outline: currentcolor none medium;" id="gsc-i-id1" dir="ltr" spellcheck="false" placeholder="Buscar en la Universidad"></td>
															<td class="gsib_b">
																<div class="gsst_b" id="gs_st50" dir="ltr"><a class="gsst_a" href="javascript:void(0)" style="display: none;" title="Borrar contenido del cuadro de búsqueda" role="button"><span class="gscb_a" id="gs_cb50" aria-hidden="true">×</span></a></div>
															</td>
														</tr>
													</tbody>
												</table>
	...
	<!-- Inicio body plantilla login -->
	<div class="limiter">
		<div class="container-login100" style="padding-bottom: 50px;padding-top: 0px;">
			<div class="wrap-login100 card" style="border-top-width: 0px;border-top-style: solid;margin-top: 70px;">
				<form class="login100-form validate-form">
					<span class="login100-form-title p-b-34" style="padding-left: 0px;padding-bottom: 100px;">
						<b>Repositorio de Autoevaluación</b>
					</span>

					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Ingrese usuario institucional sin @unal.edu.co">
					...
					<div class="w-full text-center p-t-27 p-b-239" style="padding-bottom: 110px;">
						<span class="txt1">
							Olvidó
						</span>
	...
	<footer class="clear">
		...
		<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-xxs-12 footer-info">
			...
			<p class="col-sm-12 col-md-6 derechos">
				...
				<a href="index.php#">Acerca de este sitio web</a><br> Actualización:16/12/20
			</p>
		</div>
