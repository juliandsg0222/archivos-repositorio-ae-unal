...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/facultades.css" media="all">
								...
								<div class="row" style="width: 100%; margin-bottom: 48px">
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/FA.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Facultad de Administración</h2>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/FCEN.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/FIA.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
