...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/pregrado_posgrado.css" media="all">
					...
					<div class="card-body" style="margin-bottom:0">
						<div class="version2">
							...
							<div class="container" style="width: 100%;">
								...
								<div class="row" style="width: 100%; margin-bottom: 21px"></div>
								...
								<div class="row" style="width: 100%; margin-bottom: 48px">
									<div class="col-md-5 col-sm-8 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/pregrado.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
									...
									<div class="col-md-5 col-sm-8 col-xs-12">
										<div class="card hovereffect2" style="width: 100%; min-height: 100%; margin-left: 55% !important">
											<img class="card-img-top img-responsive" src="./images/posgrado.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Editar Perfil</h2>
												<a class="info2" href="./index.php"></a>
											</div>
