    ...
    <header id="unalTop">
        ...
        <div id="bs-navbar" class="navigation d-none d-md-block">
            ...
            <div class="navbar-dark mainMenu" id="main_menu_container">
                ...
                <!-- Inicio items menú secundario plantilla unal -->
                <div class="btn-group">
                    <a href="#" class="btn btn-default">Manual de Usuario</a>
                </div>
                <!-- Fin items menú secundario plantilla unal -->
                ...
                <div class="card-body" style="margin-bottom:0;">
                    <div class="version2">
                        ...
                        <div class="container" style="width: 96%; margin:30px">
                            <br>
                            <h1 style="color: rgb(30, 111, 193); font-size: 4.5em"><b>Manual de Usuario</b></h1>
                            <embed src="Manual_Usuario.pdf" type="application/pdf" width="100%" height="600px" style="float:left"/>
                        </div>
                    </div>
                </div>
            </div>
