...
<body>
  ...
  <header id="unalTop">
    ...
    <div id="bs-navbar" class="navigation d-none d-md-block">
      ...
      <div class="site-url" id="subdominio">
        <a href="https://repositorio.manizales.unal.edu.co/">repositorio.manizales.unal.edu.co</a>
      </div>
      ...
      <div class="navbar-dark mainMenu" id="main_menu_container">
        ...
        <!-- Inicio items menú secundario plantilla unal -->
        <div class="btn-group">
          <a href="informacion.php" class="btn btn-default">Información General</a>
        </div>
        <!-- Fin items menú secundario plantilla unal -->

        <!-- Inicio items menú secundario plantilla unal -->
        <div class="btn-group">
          <a href="manual.php" class="btn btn-default">Manual de Usuario</a>
        </div>
        <!-- Fin items menú secundario plantilla unal -->
  ...
  <div class="limiter">
    <div class="container-login100" style="padding-bottom: 50px;padding-top: 0px;">
      <div class="wrap-login100 card" style="border-top-width: 0px;border-top-style: solid;margin-top: 70px;">
        <form class="login100-form validate-form" id="formlg" action="">
          ...
          <span class="login100-form-image p-b-34">
            <h5>Se recomienda el uso de</h5>
            <a href="https://www.mozilla.org/es-ES/firefox/new/"><img src="estilos/images/mozilla.png" style="width: 20%; float: center"></a>
  ...
  <script src="estilos/js/login2.js"></script>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-12 footer-info">
        <div class="row footer-info-spacing">
          ...
          <p class="col-lg-6 col-md-12 col-sm-12 col-6 derechos">
            ...
            <a href="informacion.php">Acerca de este sitio web</a><br />
