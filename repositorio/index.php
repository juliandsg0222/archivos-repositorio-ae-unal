...
<html lang=es>
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="estilos/css/log1.css">
    <link rel="stylesheet" type="text/css" href="estilos/css/log2.css">
    ...
    <header id="unalTop">
      ...
      <!-- Fin título del sitio plantilla unal -->
        ...
        <div class="btn-group d-none">
          <div class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="navbarSupportedContent"
      ...
      <nav class="navbar navbar-light light-blue lighten-4 main_menu">
        ...
        <div class="collapse navbar-collapse" id="navbar_content">
          ...
          <div class="btn-group d-block d-md-none hidden-print">
            <div class="btn btn-default dropdown-toggle" data-toggle="collapse" data-target="#container_sedes_mobil"
              aria-controls="container_sedes_mobil">Sedes<span class="caret"> </span>
            </div>
          </div>
          <!-- Fin sedes plantilla unal -->
          ...
          <!-- Inicio servicios plantilla unal -->
          <div class="btn-group d-block d-md-none hidden-print">
            <div class="btn btn-default dropdown-toggle" data-toggle="collapse" data-target="#container_servicios_mobil"
              aria-controls="container_servicios_mobil">Servicios<span class="caret"> </span>
            </div>
          </div>
          <!-- Fin servicios plantilla unal -->
          ...
          <!-- Inicio perfiles plantilla unal -->
          <div class="btn-group d-block d-md-none hidden-print">
            <div class="btn btn-default dropdown-toggle" data-toggle="collapse" data-target="#container_profiles_mobil"
              aria-controls="container_profiles_mobil">Perfiles<span class="caret"> </span>
            </div>
          </div>
          <!-- Fin perfiles plantilla unal -->
    ...
    <div class="limiter">
      <div class="container-login100" style="padding-bottom: 50px;padding-top: 0px;">
        <div class="wrap-login100 card" style="border-top-width: 0px;border-top-style: solid;margin-top: 70px;">
          <form class="login100-form validate-form" method="POST" action="usuarios/controlador/login.php">          
          
            <span class="login100-form-image p-b-34">
            <img src="estilos/images/autoevaluacion.png" style="width: 100%;">
            </span>
            ...
            <div class="container-login100-form-btn">
              <input class="login100-form-btn" type="submit" value="Inciar sesión">
            </div>
