            ...
            <div class="container" style="width: 100%; margin-left: 0px; padding-left: 0px; margin-right: 0px; padding-right: 0px;">
              ...
              <script>
                  ...
                  function llamarIndicadores(){
                    ...
                    tablas.innerHTML ='<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">INDICADOR</th><th scope="col">DESCRIPCION</th><th scope="col" style="size:500px">ACCIÓN</th></tr></thead><tbody><?php $Indicadores = $ModeloConfiguracion->getIndicadores(); $cont = 1; if ($Indicadores != null) { foreach ($Indicadores as $ind) { ?><tr><th scope="row"><?php echo $cont++ ?></th><td><?php echo $ind["numInd"] ?></td><td style="text-align: justify"><?php echo $ind["nomInd"] ?></td><td><a style="text-decoration: none; color: rgb(244, 183, 61)" href="Uindicador.php?transaction=<?php echo $ind['idInd']?>"><i class="fas fa-edit" title="Editar"></i></a>   <a style="text-decoration: none; color: rgb(166, 28, 49)" href="Dperiodo.php?transaction=<?php echo $ind['idInd']?>"><i class="fas fa-trash-alt" title="Eliminar"></i></a></td></tr><?php } } ?></tbody></table>';                   
                  }
