    ...
    <div class="container" id="advanced-search-form">
        ...
        ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Nombre Completo" name="nombre" autocomplete="off" value="<?php echo $info['nomUsu'] ?>" disabled>
            </div>
            <div class="clearfix"></div>

            <div class="form-group">
                <label>Contraseña</label>
                <input type="password" class="form-control" placeholder="Contraseña" name="contrasena" autocomplete="off" value="<?php echo $info['passUsu'] ?>" disabled>
            </div>
            <div class="clearfix"></div>

            <div class="form-group">
                <label>Rol</label>
                <select name="rol" required="" class="form-control" disabled>
