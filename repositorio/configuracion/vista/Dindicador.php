...
<body>
    <div class="container" id="advanced-search-form">
        <h2><b>Eliminar Indicador<b></h2>
        <form method="POST" action="../controlador/deleteIndicador.php">
        ...
        ?>
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Indicador" name="indicador" autocomplete="off" value="<?php echo $info['numInd'] ?>" disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Descripción del indicador" name="descripcion" autocomplete="off" disabled><?php echo $info['nomInd'] ?></textarea>
            </div>
