...
<body>
    <div class="container" id="advanced-search-form">
        ...
        <form method="POST" action="../controlador/deletePeriodo.php">
        ...
        ?>
            <div class="form-group">
                <label>Período</label>
                <input type="text" class="form-control" placeholder="Período Académico" name="periodo" autocomplete="off" value="<?php echo $info['nomPer'] ?>" disabled>
            </div>
