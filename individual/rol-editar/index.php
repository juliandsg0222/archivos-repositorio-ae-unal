...
<head>
  ...
  <!-- Fin head plantilla base -->
	...
	<link rel="stylesheet" type="text/css" href="css/rol-editar.css" media="all">
            ...
            <div class="version2">
              ...
              <div class="col-md-5 col-sm-8 col-xs-12">
										<div class="card hovereffect2" style="width: 100%;">
											<img class="card-img-top img-responsive" src="./images/rol.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
                  ...
                  <div class="col-md-5 col-sm-8 col-xs-12">
										<div class="card hovereffect2" style="width: 100%;">
											<img class="card-img-top img-responsive" src="./images/config.jpg" alt="Sans &amp; Sans-Serif">
											<div class="overlay2">
												<h2>Editar Perfil</h2>
												<a class="info2" href="./index.php"></a>
											</div>
