...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/rol.css" media="all">
...
<body>
    ...
    <!-- Inicio body plantilla rol-editar -->
                            ...
                            <div class="row" style="width: 100%; margin-bottom: 48px">
                                <div class="col-md-4 col-sm-8 col-xs-12">
                                    <div class="card hovereffect2" style="width: 100%;">
                                        <img class="card-img-top img-responsive" src="./images/admin.jpg" alt="Sans &amp; Sans-Serif">
                                        <div class="overlay2">
                                            <h2>Administrador</h2>
                                ...
                                <div class="col-md-4 col-sm-8 col-xs-12">
                                    <div class="card hovereffect2" style="width: 100%;">
                                        <img class="card-img-top img-responsive" src="./images/editor.jpg" alt="Sans &amp; Sans-Serif">
                                        <div class="overlay2">
                                            <h2>Editor</h2>
                                ...
                                <div class="col-md-4 col-sm-8 col-xs-12">
                                    <div class="card hovereffect2" style="width: 100%;">
                                        <img class="card-img-top img-responsive" src="./images/visualizador.jpg" alt="Sans &amp; Sans-Serif">
                                        <div class="overlay2">
                                            <h2>Visualizador</h2>
                                            <a class="info2" href="../../categorias/vista/index.php"></a>
                                        </div>
