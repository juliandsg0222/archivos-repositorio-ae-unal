...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../estilos/css/rol.css" media="all">
        ...
        <div id="panel" class="panel panel-default" style="width: 100%; text-align:center; height: 100%;">
            ...
            <div class="card" style="margin: 40px 4% 0 4%; transform: translateX(0);">
                ...
                <nav class="navbar navbar-dark card-nav1">
                    <li class="nav-item"><a href="../../rol-editar/vista/index.php" style="color: white;"><i class="fas fa-arrow-alt-circle-left" title="Atrás"></i></a></li>
