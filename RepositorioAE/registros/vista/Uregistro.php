...
<body>
    <div class="container" id="advanced-search-form">
        <h2><b>Actualizar Registro<b></h2>
        <form method="POST" action="../controlador/editRegistro.php">
            ...
            ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nombre del Registro" name="nombre" autocomplete="off" value="<?php echo $info['nomReg'] ?>" required="">
                    </div>
                    <div class="clearfix"></div>

                    <div class="form-group">
                        <label>Descripción</label>
                        <textarea class="form-control" placeholder="Descripción" name="descripcion" autocomplete="off" required=""><?php echo $info['desReg'] ?></textarea>
                    </div>
                    <div class="clearfix"></div>

                    <div class="form-group">
                        <label>Link de Acceso</label>
                        <input type="url" class="form-control" placeholder="Link de acceso" name="acceso" autocomplete="off" required="" value="<?php echo $info['linkReg'] ?>">
                    </div>
                    <div class="clearfix"></div>
