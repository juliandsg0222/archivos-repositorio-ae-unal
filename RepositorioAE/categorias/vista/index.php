      ...
      <div class="card" style="margin: 40px 4% 0 4%; transform: translateX(0);">
        <nav class="navbar navbar-dark card-nav1">
          ...
          if ($Perfil == 'VISUALIZADOR' || $Perfil == 'EDITOR') {
            $link = '../../rol-editar/vista/index.php';
          } else if ($Perfil == 'ADMINISTRADOR') {
            $link = '../../rol/vista/index.php';
          }
          ?>

          <li class="nav-item"><a href="<?php echo $link ?>" style="color: white;"><i class="fas fa-arrow-alt-circle-left" title="Atrás"></i></a></li>
