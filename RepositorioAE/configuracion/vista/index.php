              ...
              <div id="EspacioConsulta">
                <script>
                  function llamarUsuarios() {
                    ...
                    tablas.innerHTML = '<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">USUARIO</th><th scope="col">NOMBRE</th><th scope="col">ROL</th><th scope="col">ACCIÓN</th></tr></thead><tbody><?php $Usuarios = $ModeloConfiguracion->getUsuarios();
                                                                                                                                                                                                                                                            $cont = 1;
                                                                                                                                                                                                                                                            if ($Usuarios != null) {
                  ...
                  function llamarPeriodos() {
                    ...
                    tablas.innerHTML = '<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">PERÍODO</th><th scope="col">ACCIÓN</th></tr></thead><tbody><?php $Periodos = $ModeloConfiguracion->getPeriodos();
                                                                                                                                                                                                        $cont = 1;
                                                                                                                                                                                                        if ($Periodos != null) {
                  ...
                  function llamarProgramas() {
                    EspacioConsulta.innerHTML = '<h1 id="titAdmin" style="text-align: left; margin-left: 1%;"><i class="fas fa-caret-right"></i><b>Programas Académicos</b></h1><button type="button" class="btn btn-success"><a style="text-decoration: none; color:white;" href="Cprograma.php"><i class="fas fa-graduation-cap"></i>  Nuevo Programa Académico</a></button><div id="tablas" style="height: auto;"></div>';

                    tablas.innerHTML = '<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">PROGRAMA</th><th scope="col">ACCIÓN</th></tr></thead><tbody><?php $Programas = $ModeloConfiguracion->getProgramas();
                                                                                                                                                                                                          $cont = 1;
                                                                                                                                                                                                          if ($Programas != null) {
                  ...
                  function llamarCategorias() {
                    ...
                    tablas.innerHTML = '<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">CATEGORÍA</th><th scope="col">DESCRIPCIÓN</th><th scope="col">ACCIÓN</th></tr></thead><tbody><?php $Categorias = $ModeloConfiguracion->getCategorias();
                                                                                                                                                                                                                                          $cont = 1;
                                                                                                                                                                                                                                          if ($Categorias != null) {
                  ...
                  function llamarTemas() {
                    EspacioConsulta.innerHTML = '<h1 id="titAdmin" style="text-align: left; margin-left: 1%;"><i class="fas fa-caret-right"></i><b>Temas</b></h1><button type="button" class="btn btn-success"><a style="text-decoration: none; color:white;" href="Ctema.php"><i class="fas fa-bookmark"></i>  Nuevo Tema</a></button><div id="tablas" style="height: auto;"></div>';

                    tablas.innerHTML = '<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">TEMA</th><th scope="col">DESCRIPCIÓN</th><th scope="col">ACCIÓN</th></tr></thead><tbody><?php $Temas = $ModeloConfiguracion->getTemas();
                                                                                                                                                                                                                                      $cont = 1;
                                                                                                                                                                                                                                      if ($Temas != null) {
                  ...
                  function llamarIndicadores() {
                    EspacioConsulta.innerHTML = '<h1 id="titAdmin" style="text-align: left; margin-left: 1%;"><i class="fas fa-caret-right"></i><b>Indicadores</b></h1><button type="button" class="btn btn-success"><a style="text-decoration: none; color:white;" href="Cindicador.php"><i class="fas fa-chart-bar"></i>  Nuevo Indicador</a></button><div id="tablas" style="height: auto;"></div>';

                    tablas.innerHTML = '<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">INDICADOR</th><th scope="col">DESCRIPCION</th><th scope="col" style="size:500px">ACCIÓN</th></tr></thead><tbody><?php $Indicadores = $ModeloConfiguracion->getIndicadores();
                                                                                                                                                                                                                                                              $cont = 1;
                                                                                                                                                                                                                                                              if ($Indicadores != null) {
                  ...
                  function llamarRelaciones() {
                    ...
                    tablas.innerHTML = '<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">CATEGORÍA</th><th scope="col">TEMA</th><th scope="col">INDICADOR</th></tr></thead><tbody><?php $Relaciones = $ModeloConfiguracion->getRelaciones();
                                                                                                                                                                                                                $cont = 1;
                                                                                                                                                                                                                if ($Relaciones != null) {
                  ...
                  function llamarFuentes() {
                    ...
                    tablas.innerHTML = '<table class="table table-hover"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">FUENTE</th><th scope="col">ACCIÓN</th></tr></thead><tbody><?php $Fuentes = $ModeloConfiguracion->getFuentes();
                                                                                                                                                                                                        $cont = 1;
                                                                                                                                                                                                        if ($Fuentes != null) {
